...
def estimate_cohort_sdid_effects(
    ...
    if not isinstance(treated_indices, list) or not all(isinstance(i, (int, np.integer)) for i in treated_indices):
        raise MlsynthDataError("'treated_indices' must be a list of integers or NumPy integers.")
