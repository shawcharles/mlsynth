    ...
    def fit(self) -> BaseEstimatorResults: # Main method to fit the FSCM estimator
        ...
        try:
            if self.display_graphs:
                ...
                # Call the plot_estimates utility to generate and display/save plots.
                plot_estimates(
                    df=prepared_data_dict, # Data prepared by dataprep
                    ...
                    treated_unit_name=prepared_data_dict["treated_unit_name"], # Name of the treated unit
                    y=prepared_data_dict["y"], # Observed outcome series for the treated unit
                    cf_list=[counterfactual_vector_for_plot], # List containing the counterfactual series
                    counterfactual_names=[f"FSC {prepared_data_dict['treated_unit_name']}"], # Name for the counterfactual series in the plot
                    method="FSCM", # Method name for plot title
