        ...
        if self.display_graphs:
            try:
                ...
                if (
                    ...
                    plot_estimates(
                        df=prepared_panel_data, # Pass dataprep output for context if needed by plotter.
                        ...
                        treatmentname=self.treat, # Name of the treatment column (for plot title/label).
                        treated_unit_name=prepared_panel_data["treated_unit_name"], # Name of the treated unit.
                        y=prepared_panel_data["y"],  # Observed outcome series (pd.Series from dataprep).
                        cf_list=[counterfactual_series_for_plotting],  # List containing the counterfactual (np.ndarray).
                        ...
                        method=_PLOT_METHOD_NAME, # Overall method name for the plot (e.g., "TSSC").
                        ...
                        save_path=self.save if isinstance(self.save, str) else None, # Path for saving the plot.
                    )
                else:
