            ...
            if counterfactual_vectors_for_plot: 
                ...
                try:
                    ...
                    plot_estimates( 
                        ...
                        y=prepared_data["y"], # Observed outcome vector.
                        cf_list=counterfactual_vectors_for_plot, # List of counterfactual vectors.
                        counterfactual_names=legend_names_for_counterfactuals, # Names for legend.
                        method="CLUSTERSC", # Overall method name for plot title/saving.
                        treatedcolor=self.treated_color,
                        counterfactualcolors=counterfactual_line_colors,
                        save=self.save, 
                    )
