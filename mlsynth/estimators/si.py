    ...
    def fit(self) -> Dict[str, BaseEstimatorResults]: # Changed return type
        ...
        if self.display_graphs and counterfactuals_list and focal_unit_prepared_data:
            ...
            try:
                ...
                plot_estimates(
                    df=focal_unit_prepared_data, # Pass the prepared data for context if needed by plotter.
                    ...
                    treatmentname="Focal Treatment Start", # Label for the treatment start time.
                    treated_unit_name=str(focal_unit_prepared_data["treated_unit_name"]), # Name of the focal treated unit.
                    y=focal_unit_prepared_data["y"], # Observed outcome series of the focal unit.
                    cf_list=counterfactuals_list, # List of estimated counterfactual series.
                    counterfactual_names=counterfactual_names_list, # Names for each counterfactual series.
                    method="SI", # Method name for plot titles/legends.
                    treatedcolor=self.treated_color, # Color for the observed outcome line.
                    counterfactualcolors=( # Colors for the counterfactual lines.
                    ...
                    save=self.save, # Plot saving configuration.
                )
